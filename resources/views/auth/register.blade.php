                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label>
                                        <input class="form-check-input" type="radio" name="role" id="role"  value="1"> administrador
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label>
                                        <input class="form-check-input" type="radio" name="role" id="role" value="2" checked> cliente
                                    </label>
                                </div>
                            </div>
                        </div>
